...
import style from "./castInMovie.module.css";
...
export default function GetCastInMovie({ id }) {
  ...
  return (
    <div id={style.CastContainer}>
      {infoCharacterRef.current && infoCharacterRef.current.length > 0 &&
        infoCharacterRef.current.map((char, index) => {
          return (
            <div className={style.card}>
              <div className={style.avatar} style={{backgroundImage: `url(https://image.tmdb.org/t/p/w500${char.profile_path})`}}>
